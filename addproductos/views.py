...
from addproductos.models import Cart, CartItem
...
def add_to_cart(request):
    ...
    if not errors:
        ...
        cart.update_total()
        return Response({'cart_id': cart.id, 'products': response_data, 'precio_total': cart.precio_total}, status=status.HTTP_201_CREATED)
    else:
